...
`detect_video.py` runs inference with `conf=0.3` and `imgsz=1280` (higher resolution improves small object detection on security camera footage). Output video is saved to `runs/detect/`.
